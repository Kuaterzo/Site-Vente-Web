...
CREATE TABLE "Product" (
    ...
    "isPublicPrice" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "TechnicalSheet" ADD CONSTRAINT "TechnicalSheet_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
